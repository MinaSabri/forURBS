...
# lower bound <= storage capacity <= upper bound; TES storage is dependent of turbine capacity if design-factor is used.
def res_storage_capacity_rule(m, stf, sit, sto, com):
    if (m.storage_dict['design-factor'][(stf,sit,sto,com)] > 0):
        if(com == 'HeatTokamak'):
            return (m.cap_sto_c[stf, sit, sto, com] == m.storage_dict['design-factor'][(stf, sit, sto, com)] * m.cap_pro[stf, sit, 'Fusion_Tokamak'])
        elif (com == 'HeatStellarator'):
            return (m.cap_sto_c[stf, sit, sto, com] == m.storage_dict['design-factor'][(stf, sit, sto, com)] * m.cap_pro[stf, sit, 'Fusion_Stellarator'])
        elif (sto == 'Car_Plug_in_Tank_Elec'):
            return (m.cap_sto_c[stf, sit, sto, com] == m.storage_dict['design-factor'][(stf, sit, sto, com)] * m.cap_pro[stf, sit, 'pt_car_plug_in'])
        elif (sto == 'Car_Elec_Tank'):
            return (m.cap_sto_c[stf, sit, sto, com] == m.storage_dict['design-factor'][(stf, sit, sto, com)] * m.cap_pro[stf, sit, 'pt_car_bev'])
        elif (sto == 'Car_Hydrogen_Tank'):
            return (m.cap_sto_c[stf, sit, sto, com] == m.storage_dict['design-factor'][(stf, sit, sto, com)] * m.cap_pro[stf, sit, 'pt_car_hydrogen'])
        elif (sto == 'Bus_Elec_Tank'):
            return (m.cap_sto_c[stf, sit, sto, com] == m.storage_dict['design-factor'][(stf, sit, sto, com)] * m.cap_pro[stf, sit, 'pt_bus_bev'])
        elif (sto == 'Bus_Plug_in_Tank_Elec'):
            return (m.cap_sto_c[stf, sit, sto, com] == m.storage_dict['design-factor'][(stf, sit, sto, com)] * m.cap_pro[stf, sit, 'pt_bus_plug_in'])
        elif (sto == 'Bus_Hydrogen_Tank'):
            return (m.cap_sto_c[stf, sit, sto, com] == m.storage_dict['design-factor'][(stf, sit, sto, com)] * m.cap_pro[stf, sit, 'pt_bus_hydrogen'])
        elif (sto == 'Train_PKM_Elec_Tank'):
            return (m.cap_sto_c[stf, sit, sto, com] == m.storage_dict['design-factor'][(stf, sit, sto, com)] * m.cap_pro[stf, sit, 'pt_train_electric'])
        elif (sto == 'Train_PKM_Hydrogen_Tank'):
            return (m.cap_sto_c[stf, sit, sto, com] == m.storage_dict['design-factor'][(stf, sit, sto, com)] * m.cap_pro[stf, sit, 'pt_train_hydrogen'])
        elif (sto == 'Plane_PKM_Hydrogen_Tank'):
            return (m.cap_sto_c[stf, sit, sto, com] == m.storage_dict['design-factor'][(stf, sit, sto, com)] * m.cap_pro[stf, sit, 'pt_plane_hydrogen'])
        elif (sto == 'Ship_PKM_Hydrogen_Tank'):
            return (m.cap_sto_c[stf, sit, sto, com] == m.storage_dict['design-factor'][(stf, sit, sto, com)] * m.cap_pro[stf, sit, 'pt_ship_hydrogen'])
        elif (sto == 'Truck_Elec_Tank'):
            return (m.cap_sto_c[stf, sit, sto, com] == m.storage_dict['design-factor'][(stf, sit, sto, com)] * m.cap_pro[stf, sit, 'ft_truck_bev'])
        elif (sto == 'Truck_Plug_in_Tank_Elec'):
            return (m.cap_sto_c[stf, sit, sto, com] == m.storage_dict['design-factor'][(stf, sit, sto, com)] * m.cap_pro[stf, sit, 'ft_truck_plug_in'])
        elif (sto == 'Train_TKM_Elec_Tank'):
            return (m.cap_sto_c[stf, sit, sto, com] == m.storage_dict['design-factor'][(stf, sit, sto, com)] * m.cap_pro[stf, sit, 'ft_train_electric'])
        elif (sto == 'Train_TKM_Hydrogen_Tank'):
            return (m.cap_sto_c[stf, sit, sto, com] == m.storage_dict['design-factor'][(stf, sit, sto, com)] * m.cap_pro[stf, sit, 'ft_train_hydrogen'])
        elif (sto == 'Plane_TKM_Hydrogen_Tank'):
            return (m.cap_sto_c[stf, sit, sto, com] == m.storage_dict['design-factor'][(stf, sit, sto, com)] * m.cap_pro[stf, sit, 'ft_plane_hydrogen'])
        elif (sto == 'Ship_TKM_Hydrogen_Tank'):
            return (m.cap_sto_c[stf, sit, sto, com] == m.storage_dict['design-factor'][(stf, sit, sto, com)] * m.cap_pro[stf, sit, 'ft_ship_hydrogen'])
        else:
