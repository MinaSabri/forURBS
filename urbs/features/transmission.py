...
def add_transmission(m):
    ...
    m.tra_tuples = pyomo.Set(
        ...
        #    '(2020,SouthGermany,MidGermany,hvac,Elec)')    #Original Value Mid #Original Value South
        doc='Combinations of possible transmissions, e.g. '
            '(2020,SouthGermany,NorthGermany,hvac,Elec)')
...
def add_transmission_dc(m):
    ...
    m.tra_tuples = pyomo.Set(
        ...
        #    ' e.g. (2020,SouthGermany,MidGermany,hvac,Elec)')   #Original Value Mid #Original Value South
        doc = 'Combinations of possible transmissions,'
            'without duplicate dc transmissions'
            ' e.g. (2020,SouthGermany,NorthGermany,hvac,Elec)')
    ...
    m.tra_tuples_dc = pyomo.Set(
        ...
        #    'transmissions, e.g. (2020,SouthGermany,MidGermany,hvac,Elec)') #Original Value Mid #Original Value South
        doc = 'Combinations of possible bidirectional dc'
            'transmissions, e.g. (2020,SouthGermany,NorthGermany,hvac,Elec)')
