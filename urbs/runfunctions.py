...
from urbs.report import *
from urbs.plot import *
from urbs.input import *
from urbs.validation import *
from urbs.saveload import *
...
def setup_solver(optim, logfile='solver.log'):
    ...
    if optim.name == 'gurobi':
        ...
        optim.set_options("log={}".format(logfile))
        #New Addition of Solver 24th April
    elif optim.name == 'cbcpy':
        optim.set_options("log={}".format(logfile))
    else:
...
def run_scenario(input_files, Solver, timesteps, scenario, result_dir, dt,
    ...
    #print(result)   #New addtion
    #try:
    assert str(result.solver.termination_condition) == 'optimal', "No optimal solution possible"
    # New addtion
