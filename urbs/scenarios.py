...
# def scenario_co2_tax_north(data): #in actual it should be scenario_co2_tax_mid
...
#     return data
#
# def scenario_co2_tax_south(data):
#     #change CO2 price in South
#     co = data['commodity']
#     for stf in data['global_prop'].index.levels[0].tolist():
#         co.loc[(stf, 'SouthGermany', 'CO2', 'Env'), 'price'] = 50
#     return data
def scenario_co2_tax_europe(data):      #Original Scenario = north and south
    #change CO2 price in Mid
    co = data['commodity']
    for stf in data['global_prop'].index.levels[0].tolist():
        co.loc[(stf, 'AUT', 'CO2', 'Env'), 'price'] = 50   #Original Value North Germany/SouthGermany
        co.loc[(stf, 'BEL', 'CO2', 'Env'), 'price'] = 50  # Original Value North Germany/SouthGermany
        co.loc[(stf, 'CHE', 'CO2', 'Env'), 'price'] = 50  # Original Value North Germany/SouthGermany
        co.loc[(stf, 'CZE', 'CO2', 'Env'), 'price'] = 50  # Original Value North Germany/SouthGermany
        co.loc[(stf, 'DEU', 'CO2', 'Env'), 'price'] = 50  # Original Value North Germany/SouthGermany
        co.loc[(stf, 'DNK', 'CO2', 'Env'), 'price'] = 50  # Original Value North Germany/SouthGermany
        co.loc[(stf, 'FRA', 'CO2', 'Env'), 'price'] = 50  # Original Value North Germany/SouthGermany
        co.loc[(stf, 'LUX', 'CO2', 'Env'), 'price'] = 50  # Original Value North Germany/SouthGermany
        co.loc[(stf, 'NLD', 'CO2', 'Env'), 'price'] = 50  # Original Value North Germany/SouthGermany
        co.loc[(stf, 'POL', 'CO2', 'Env'), 'price'] = 50  # Original Value North Germany/SouthGermany
    return data


# def scenario_europe_process_caps(data):          #Original def scenario_north_process_caps(data):
